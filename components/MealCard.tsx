...
import { ChevronDown, ChevronUp, Clock, ShoppingBag, UtensilsCrossed, Heart, CheckCircle2 } from 'lucide-react'
...
interface MealCardProps {
  ...
  mealKey?: string   // e.g. 'breakfast', 'lunch', 'dinner' — for eaten tracking
}
